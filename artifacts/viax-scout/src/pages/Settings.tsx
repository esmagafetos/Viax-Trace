            ...
            <div style={cardBody}>
              {settingsLoading ? (
                ...
                <>
                  ...
                  {/* geocodebr info — endpoint hospedado pelo ViaX:Trace */}
                  {instanceMode === "geocodebr" && (
                    <div style={{ marginBottom: "1.25rem", padding: "1.1rem 1.2rem", borderRadius: 10, background: "rgba(124,58,237,0.05)", border: "1px solid rgba(124,58,237,0.2)" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.4rem" }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#7c3aed" strokeWidth="2.5"><polyline points="20,6 9,17 4,12"/></svg>
                        <strong style={{ fontSize: "0.85rem", color: "#7c3aed" }}>Endpoint hospedado pelo ViaX:Trace</strong>
                      </div>
                      <div style={{ fontSize: "0.72rem", color: "var(--text-faint)", lineHeight: 1.6 }}>
                        Sem configuração necessária. O serviço CNEFE/IBGE roda na nossa infraestrutura e é usado automaticamente como <strong>fallback</strong> para endereços que Photon/Overpass/Nominatim não localizaram — ideal para interior do país e loteamentos pouco mapeados.
                      </div>
                    </div>
                  )}
